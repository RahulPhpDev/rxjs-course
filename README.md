...
This operator use for stop mutliple subscription, The current problem is the times we subscribe
observable it recall the site-effect

so we have this shareReplay operator which share the content to all the subscribier
without many more content
